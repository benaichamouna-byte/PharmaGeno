# deep_learning_v4.py
# DL avec 6 features - gène, médicament, rsID, association, direction, population
...
# ONE-HOT ENCODING sur 6 features
print("\nOne-Hot Encoding...")
...
print(f"\n{'='*50}")
print(f"Accuracy DL v1 (2 features, 19 classes) : 44.8%")
print(f"Accuracy DL v3 (2 features, 4 classes)  : 85.0%")
print(f"Accuracy DL v4 (6 features, 4 classes)  : {accuracy*100:.1f}%")
print(f"\nRapport :")
print(classification_report(y_test, y_pred,
      target_names=le_pheno.classes_, zero_division=0))

torch.save(model.state_dict(), '/home/mouna/projet_memoire/results/dl_v4_model.pth')
